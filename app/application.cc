...
void application::fill_command_buffer(vk::raii::CommandBuffer &cmd, uint32_t image_index, vk::Extent2D extent) {
  cmd.reset();
...
void application::render_frame() {
  ...
  std::transform(gui_type::params.colors.begin(), gui_type::params.colors.end(), uniform_buffer.colors.begin(),
